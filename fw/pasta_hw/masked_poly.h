...
#define masked_poly_add_unmasked DILITHIUM_NAMESPACE(masked_poly_add_unmasked)
void masked_poly_add_unmasked(masked_poly *r, poly *a, masked_poly *b);

#define masked_poly_mult_add_const DILITHIUM_NAMESPACE(masked_poly_mult_add_const)

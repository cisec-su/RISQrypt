...
create_clock -add -name clk_in1 -period 16.00 -waveform {0 8} [get_ports {M100_clk_i}];
...
set_property -dict { PACKAGE_PIN J13   IOSTANDARD LVCMOS33 } [get_ports { led4 }]; #IO_L17N_T2_A25_15 Sch=led[2]
...
set_property -dict { PACKAGE_PIN C4    IOSTANDARD LVCMOS33 } [get_ports { tx_o }]; #IO_L7P_T1_AD6P_35 Sch=uart_txd_in
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { rx_i }]; #IO_L11N_T1_SRCC_35 Sch=uart_rxd_out

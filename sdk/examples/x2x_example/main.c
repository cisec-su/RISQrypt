...
int main() {
    ...
    test_B_share_single_2k();
    test_B2A_single_2k();

    //TEST 2 0 --> A --> B (SINGLE-2)
    test_A_share_single_2k();
    test_A2B_single_2k();
    
    //TEST 3 0 --> B --> A (DUAL-2)
    test_B_share_dual_2k();
    test_B2A_dual_2k();
    
    //TEST 4 0 --> A --> B (DUAL-2)
    test_A_share_dual_2k();
    test_A2B_dual_2k();

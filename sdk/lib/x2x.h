...
int x2x_a2b(uint32_t *dst_1, uint32_t *dst_0, const uint32_t *src_1, const uint32_t *src0, unsigned int len);

int x2x_b2a(uint32_t *dst_1, uint32_t *dst_0, const uint32_t *src_1, const uint32_t *src0, unsigned int len);

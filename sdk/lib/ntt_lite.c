...
unsigned int ntt_lite_load_q_cc = 0;
unsigned int ntt_lite_set_q_cc = 0;
unsigned int ntt_lite_set_ctrl_cc = 0;
unsigned int ntt_lite_set_inv2_cc = 0;
unsigned int ntt_lite_set_mu_cc = 0;
unsigned int ntt_lite_set_bound_cc = 0;
unsigned int ntt_lite_set_clr_cc = 0;
unsigned int ntt_lite_set_clr_with_twiddle_cc = 0;
unsigned int ntt_lite_load_twiddle_cc = 0;
unsigned int ntt_lite_load_zeta_cc = 0;
unsigned int ntt_lite_read_twiddle_cc = 0;
unsigned int ntt_lite_read_poly_cc = 0;
unsigned int ntt_lite_forward_ntt_cc = 0;
unsigned int ntt_lite_backward_ntt_cc = 0;
unsigned int ntt_lite_pwm_cc = 0;
unsigned int ntt_lite_mul_const_cc = 0;
unsigned int ntt_lite_mac_cc = 0;
unsigned int ntt_lite_add_cc = 0;
unsigned int ntt_lite_add_const_cc = 0;
unsigned int ntt_lite_sub_cc = 0;
unsigned int ntt_lite_sub_const_cc = 0;
unsigned int ntt_lite_sub_rev_cc = 0;
unsigned int ntt_lite_sub_rev_const_cc = 0;
unsigned int ntt_lite_sum_cc = 0;
unsigned int ntt_lite_encode_cc = 0;
unsigned int ntt_lite_decode_cc = 0;
unsigned int ntt_lite_cbd_cc = 0;
unsigned int ntt_lite_rejsamp_cc = 0;
unsigned int ntt_lite_compress_cc = 0;
unsigned int ntt_lite_decompress_cc = 0;
unsigned int ntt_lite_decompress_floor_cc = 0;
unsigned int ntt_lite_decompose_cc = 0;
unsigned int ntt_lite_chknorm_cc = 0;
unsigned int ntt_lite_make_hint_cc = 0;
unsigned int ntt_lite_use_hint_cc = 0;

#define NTT_LITE_BENCH_START(g) \
    do { \
        BENCH_START(g); \
    } while (0)

#define NTT_LITE_BENCH_END(g) \
    do { \
        BENCH_END(g); \
    } while (0)

void ntt_lite_reset_profile(void) {
    ntt_lite_load_q_cc = 0;
    ntt_lite_set_q_cc = 0;
    ntt_lite_set_ctrl_cc = 0;
    ntt_lite_set_inv2_cc = 0;
    ntt_lite_set_mu_cc = 0;
    ntt_lite_set_bound_cc = 0;
    ntt_lite_set_clr_cc = 0;
    ntt_lite_set_clr_with_twiddle_cc = 0;
    ntt_lite_load_twiddle_cc = 0;
    ntt_lite_load_zeta_cc = 0;
    ntt_lite_read_twiddle_cc = 0;
    ntt_lite_read_poly_cc = 0;
    ntt_lite_forward_ntt_cc = 0;
    ntt_lite_backward_ntt_cc = 0;
    ntt_lite_pwm_cc = 0;
    ntt_lite_mul_const_cc = 0;
    ntt_lite_mac_cc = 0;
    ntt_lite_add_cc = 0;
    ntt_lite_add_const_cc = 0;
    ntt_lite_sub_cc = 0;
    ntt_lite_sub_const_cc = 0;
    ntt_lite_sub_rev_cc = 0;
    ntt_lite_sub_rev_const_cc = 0;
    ntt_lite_sum_cc = 0;
    ntt_lite_encode_cc = 0;
    ntt_lite_decode_cc = 0;
    ntt_lite_cbd_cc = 0;
    ntt_lite_rejsamp_cc = 0;
    ntt_lite_compress_cc = 0;
    ntt_lite_decompress_cc = 0;
    ntt_lite_decompress_floor_cc = 0;
    ntt_lite_decompose_cc = 0;
    ntt_lite_chknorm_cc = 0;
    ntt_lite_make_hint_cc = 0;
    ntt_lite_use_hint_cc = 0;
}
...
int ntt_lite_load_q(uint32_t q, const uint32_t *mu, uint32_t logn, uint32_t k, uint32_t inv2, uint32_t mode) {
    ...
    NTT_LITE_BENCH_START(ntt_lite_load_q_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_load_q_cc);
    return 0;
}
...
int ntt_lite_set_ctrl(uint32_t logn, uint32_t k, uint32_t mode) {
    ...
    NTT_LITE_BENCH_START(ntt_lite_set_ctrl_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_set_ctrl_cc);
    return 0;
}


int ntt_lite_set_q(uint32_t q) {
    NTT_LITE_BENCH_START(ntt_lite_set_q_cc);

    NTT_LITE_REGS->q = q;

    NTT_LITE_BENCH_END(ntt_lite_set_q_cc);
    return 0;
}


int ntt_lite_set_inv2(uint32_t inv2) {
    NTT_LITE_BENCH_START(ntt_lite_set_inv2_cc);

    NTT_LITE_REGS->inv2 = inv2;

    NTT_LITE_BENCH_END(ntt_lite_set_inv2_cc);
    return 0;
}


int ntt_lite_set_mu(const uint32_t *mu, uint32_t mode) {
    NTT_LITE_BENCH_START(ntt_lite_set_mu_cc);

    NTT_LITE_REGS->mu[0] = mu[0];
    NTT_LITE_REGS->mu[1] = mu[1];

    NTT_LITE_BENCH_END(ntt_lite_set_mu_cc);
    return 0;
}


int ntt_lite_set_bound(uint32_t bound) {
    NTT_LITE_BENCH_START(ntt_lite_set_bound_cc);

    NTT_LITE_REGS->bound = bound;

    NTT_LITE_BENCH_END(ntt_lite_set_bound_cc);
    return 0;
}


int ntt_lite_set_clr() {
    NTT_LITE_BENCH_START(ntt_lite_set_clr_cc);

    NTT_LITE_REGS->ctrl |= NTT_LITE_CTRL_CMD_SET_CLR;
    while(!(NTT_LITE_REGS->ctrl & NTT_LITE_CTRL_DONE_V));

    NTT_LITE_BENCH_END(ntt_lite_set_clr_cc);
    return 0;
}


int ntt_lite_set_clr_with_twiddle() {
    NTT_LITE_BENCH_START(ntt_lite_set_clr_with_twiddle_cc);

    NTT_LITE_REGS->ctrl |= NTT_LITE_CTRL_CMD_SET_CLR | NTT_LITE_CTRL_OP_SWITCH_EN_V;
    while(!(NTT_LITE_REGS->ctrl & NTT_LITE_CTRL_DONE_V));

    NTT_LITE_BENCH_END(ntt_lite_set_clr_with_twiddle_cc);
    return 0;
}
...
int ntt_lite_load_twiddle(const uint32_t *psi) {
    ...
    NTT_LITE_BENCH_START(ntt_lite_load_twiddle_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_load_twiddle_cc);
    return ret;
}


int ntt_lite_load_zeta(const uint32_t *zeta) {
    NTT_LITE_BENCH_START(ntt_lite_load_zeta_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_load_zeta_cc);
    return 0;
}
...
int ntt_lite_forward_ntt(uint32_t *dst, const uint32_t *src) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_forward_ntt_cc);
    ret = ntt_lite_ntt_core(dst, src, NTT_LITE_CTRL_OP_NTT);
    NTT_LITE_BENCH_END(ntt_lite_forward_ntt_cc);
    return ret;
}
...
int ntt_lite_backward_ntt(uint32_t *dst, const uint32_t *src) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_backward_ntt_cc);
    ret = ntt_lite_ntt_core(dst, src, NTT_LITE_CTRL_OP_INTT);
    NTT_LITE_BENCH_END(ntt_lite_backward_ntt_cc);
    return ret;
}
...
int ntt_lite_mac(uint32_t *dst, const uint32_t *lhs, const uint32_t *rhs) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_mac_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_mac_cc);
    return ret;
}
...
int ntt_lite_pwm(uint32_t *dst, const uint32_t *lhs, const uint32_t *rhs) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_pwm_cc);
    ret = ntt_lite_pointwise_op(dst, lhs, rhs, NTT_LITE_CTRL_OP_PWM, 0, 0);
    NTT_LITE_BENCH_END(ntt_lite_pwm_cc);
    return ret;
}
...
int ntt_lite_add(uint32_t *dst, const uint32_t *lhs, const uint32_t *rhs) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_add_cc);
    ret = ntt_lite_pointwise_op(dst, lhs, rhs, NTT_LITE_CTRL_OP_ADD, 0, 0);
    NTT_LITE_BENCH_END(ntt_lite_add_cc);
    return ret;
}
...
int ntt_lite_sub(uint32_t *dst, const uint32_t *lhs, const uint32_t *rhs) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_sub_cc);
    ret = ntt_lite_pointwise_op(dst, lhs, rhs, NTT_LITE_CTRL_OP_SUB, 0, 0);
    NTT_LITE_BENCH_END(ntt_lite_sub_cc);
    return ret;
}
...
int ntt_lite_sub_rev_const(uint32_t *dst, const uint32_t *lhs) { 
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_sub_rev_const_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_sub_rev_const_cc);
    return ret;
}
...
int ntt_lite_encode(uint32_t *dst, const uint32_t *src, uint32_t d) {
    ...
    NTT_LITE_BENCH_END(ntt_lite_encode_cc);
    return 0;
}
...
int ntt_lite_decode(uint32_t *dst, const uint32_t *src, uint32_t d) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_decode_cc);
    ret = ntt_lite_decode_core(dst, src, d, NTT_LITE_CTRL_OP_DECODE);
    NTT_LITE_BENCH_END(ntt_lite_decode_cc);
    return ret;
}
...
int ntt_lite_cbd(uint32_t *dst, const uint32_t *src, uint32_t d) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_cbd_cc);
    if ((d != 2) && (d != 3)) {
        return -1;
    }

    ret = ntt_lite_decode_core(dst, src, d << 1, NTT_LITE_CTRL_OP_CBD);
    NTT_LITE_BENCH_END(ntt_lite_cbd_cc);
    return ret;
}
...
int ntt_lite_rejsamp(uint32_t *dst, const uint32_t *src, uint32_t d, uint32_t center) {
    uint32_t center_int;
    NTT_LITE_BENCH_START(ntt_lite_rejsamp_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_rejsamp_cc);
    return 0;
}
...
int ntt_lite_compress(uint32_t *dst, const uint32_t *src, uint32_t d) {
    ...
    uint32_t cmd;
    uint32_t out_dis;
    NTT_LITE_BENCH_START(ntt_lite_compress_cc);
#ifndef BUSY_CHECK_DIS
    if ((NTT_LITE_REGS->ctrl & NTT_LITE_CTRL_BUSY_V)) {
        return -1;
    }
    ...
    while(!(NTT_LITE_REGS->ctrl & NTT_LITE_CTRL_DONE_V));
    NTT_LITE_BENCH_END(ntt_lite_compress_cc);
    return 0;
}
...
int ntt_lite_decompress(uint32_t *dst, const uint32_t *src, uint32_t d) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_decompress_cc);
    ret = ntt_lite_decompress_core(dst, src, d, 0);
    NTT_LITE_BENCH_END(ntt_lite_decompress_cc);
    return ret;
}
...
int ntt_lite_decompress_floor(uint32_t *dst, const uint32_t *src, uint32_t d) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_decompress_floor_cc);
    ret = ntt_lite_decompress_core(dst, src, d, NTT_LITE_CTRL_ROUND_DIS_V);
    NTT_LITE_BENCH_END(ntt_lite_decompress_floor_cc);
    return ret;
}


int ntt_lite_decompose(uint32_t *dst_1, uint32_t *dst_0, const uint32_t *src) {
    NTT_LITE_BENCH_START(ntt_lite_decompose_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_decompose_cc);
    return 0;
}
...
int ntt_lite_read_twiddle(uint32_t *dst) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_read_twiddle_cc);
    ret = ntt_lite_read_core(dst, NTT_LITE_CTRL_CMD_READ_TWIDDLE);
    NTT_LITE_BENCH_END(ntt_lite_read_twiddle_cc);
    return ret;
}
...
int ntt_lite_read_poly(uint32_t *dst) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_read_poly_cc);
    ret = ntt_lite_read_core(dst, NTT_LITE_CTRL_CMD_READ_POLY);
    NTT_LITE_BENCH_END(ntt_lite_read_poly_cc);
    return ret;
}
...
int ntt_lite_chknorm(const uint32_t *src) {
    ...
    uint32_t cmd;
    uint32_t status;
    NTT_LITE_BENCH_START(ntt_lite_chknorm_cc);
    int ret;
    ...
    NTT_LITE_BENCH_END(ntt_lite_chknorm_cc);
    return ret;
}
...
int ntt_lite_make_hint(uint32_t *dst, const uint32_t *src_0, const uint32_t *src_1) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_make_hint_cc);
    ret = ntt_lite_pointwise_op(dst, src_0, src_1, NTT_LITE_CTRL_OP_MAKEHINT, 0, 0);
    NTT_LITE_BENCH_END(ntt_lite_make_hint_cc);
    return ret;
}
...
int ntt_lite_use_hint(uint32_t *dst, const uint32_t *src) {
    int ret;
    NTT_LITE_BENCH_START(ntt_lite_use_hint_cc);
    ...
    NTT_LITE_BENCH_END(ntt_lite_use_hint_cc);
    return ret;
}